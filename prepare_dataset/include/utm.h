...
#ifndef AW_AW_COMM_COORD_UTM_H_
#define AW_AW_COMM_COORD_UTM_H_
 ...
 */
inline char UTMLetterDesignator(double Lat) {
 ...
 * Written by Chuck Gantz- chuck.gantz@globalstar.com
 */
inline void LLtoUTM(const double Lat, const double Long, double& UTMNorthing,
 ...
 * Written by Chuck Gantz- chuck.gantz@globalstar.com
 */
inline void UTMtoLL(const double UTMNorthing, const double UTMEasting,
