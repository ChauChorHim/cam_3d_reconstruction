...
class FilesHandler {
    public:
        void makeFilesList(const std::string &path_to_files_folder, const std::string &path_to_list="./files_list.txt", bool shuffle=false);
        ...
        void renameFiles(const std::string &path_to_files_folder, int type = 1);
