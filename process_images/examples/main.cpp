...
int main(int argc, char** argv){
    ...
    const std::string input_folder_dir(argv[2]);
    const std::string images_list(argv[3]);
    const std::string output_folder_dir(argv[4]);
    ...
    ImagesHandler::makeImagesList(input_folder_dir, input_folder_dir+"images_list.txt", true, true);
